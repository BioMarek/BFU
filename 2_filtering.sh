...
do
	...
	gunzip -c ${file:0:12}_filtered.fastq.gz | fastq_quality_filter -Q $QUALITY -q $QF_THRESHOLD -p $QF_PERC -o ${file:0:12}_mirna.fastq
	mv ${file:0:12}_filtered.fastq.gz $OUTPUT_DIR
