...
# miRNAs with same sequence but  different names.
...
for seq_record in SeqIO.parse("Nicotiana_miRNA_D.fa", "fasta"):
    # print(seq_record.seq)  # just for our information
...
print(len(sequences)) # number of sequences that passed the filter
f_result.close()
