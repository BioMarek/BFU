...
DISC_LONG=50 # trim longer than, it that high because of because of 30 something peak in nicotiana
PROJECT_DIR=/storage/brno7-cerit/home/marek_bfu/smRNA # path to project dir
INPUT_DIR=$PROJECT_DIR/trimmed # path to input sequences without adapters
OUTPUT_DIR=$PROJECT_DIR/ncRNA/filtered # path to output sequences
